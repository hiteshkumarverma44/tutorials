...
class CustomConfigForm extends ConfigFormBase {
    ...
    public function buildForm(array $form, FormStateInterface $form_state) {
        ...
        // here we are not using the submit attribute , rather we have used the parent attribute , it will automatically consider all the required parmeters from the class.
    }
